...
const TRANSLATIONS = {
  en: {
    ...
    bi: {
      ...
      trendsTitle: "Monthly trends", salesTrend: "Sales trend", profitTrend: "Profit trend",
      ordersTrend: "Orders trend", fromMonth: "From", toMonth: "To", applyRange: "Apply",
      invalidRange: "The start month must be before the end month.",
      insightUnavailable: "AI interpretation unavailable.", notEnoughData: "Not enough data for this period.",
      actualLabel: "Data", trendLabel: "Trend line", outlierLabel: "Anomalous month",
      barChartType: "Bar chart", pieChartType: "Pie chart", lineChartType: "Line chart (per category)",
      resetRange: "Reset", otherLabel: "Other",
    },
    security: {
      title: "Cybersecurity",
  ...
  fr: {
    ...
    bi: {
      ...
      trendsTitle: "Tendances mensuelles", salesTrend: "Tendance des ventes", profitTrend: "Tendance du profit",
      ordersTrend: "Tendance des commandes", fromMonth: "De", toMonth: "À", applyRange: "Appliquer",
      invalidRange: "Le mois de début doit être avant le mois de fin.",
      insightUnavailable: "Interprétation IA indisponible.", notEnoughData: "Pas assez de données pour cette période.",
      actualLabel: "Données", trendLabel: "Droite de tendance", outlierLabel: "Mois atypique",
      barChartType: "Graphique en barres", pieChartType: "Graphique en camembert", lineChartType: "Courbes (par catégorie)",
      resetRange: "Réinitialiser", otherLabel: "Autres",
    },
    security: {
      title: "Cybersécurité",
